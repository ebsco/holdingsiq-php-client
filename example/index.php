...
<div class="ui stackable equal width three column padded grid">
    ...
    <div class="column">
        ...
        <div style="height: 100%" class="ui attached segment">
           <!-- SEARCH TYPES -->
    ...
    <div class="column">
        ...
        <!-- PROVIDER -->
        <div id="vendorResults" style="display: none; height: 100%" class="ui attached segment">
            <div id="totalVendorResults"></div>
            <div id="vendorResultsList" class="ui relaxed divided list"></div>
        </div>
        <!-- PACKAGE -->
        <div id="packageResults" style="display: none; height: 100%" class="ui attached segment">
            <div id="totalPackageResults"></div>
            <div id="packageResultsList" class="ui relaxed divided list"></div>
        </div>
        <!-- TITLE -->
        <div id="titleResults" style="display: none; height: 100%" class="ui attached segment">
