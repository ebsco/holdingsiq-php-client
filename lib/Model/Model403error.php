 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Model403error implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = '403error';
...
'subcode' => 'getSubcode'    ];
     ...
     * Sets message
     *
     * @param string $message User is not authorized to access this resource
     *
     * @return $this
     */
