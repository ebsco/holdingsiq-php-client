...
/**
 * IdentifierCustom Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IdentifierCustom implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'identifierCustom';
...
'type' => 'getType'    ];
     ...
     * Sets subtype
     *
     * @param int $subtype Subtype for the identifier.  Valid values are 1 for Print and 2 for Online.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param int $type Type of identifier.  Valid values are 0 for ISSN and 1 for ISBN.
     *
     * @return $this
     */
